...
P_range=[1000,3000]; %(default:1500,20000)
N=50; %Iterations of Polymer/chain (DNA) generation (default:100)
...
for pp=1:P
    ...
    rand_angles=sqrt(length_link/length_persist)*randn(N,K_select);
